!(function () {
    ...
    (s =
      r.src.indexOf("?") > -1
        ? r.src +
          "&cb=" +
          t.toString() +
          "&fingerprint=c2VwLW5vLXJlZGlyZWN0&onIframeFlag"
        : r.src +
          "?cb=" +
          t.toString() +
          "&fingerprint=c2VwLW5vLXJlZGlyZWN0&onIframeFlag");
  try {
    if (
      void 0 === window.sarazasarazaNoti ||
      null === window.sarazasarazaNoti ||
      (window.sarazasarazaNoti === Array &&
        window.sarazasarazaNoti.indexOf(r.src) < 0)
    ) {
      (void 0 !== window.sarazasarazaNoti &&
        null !== window.sarazasarazaNoti) ||
        (window.sarazasarazaNoti = new Array()),
...
document.addEventListener(
  ...
  function () {
    ...
    // esr.src = "http://tareinlettartar.com/rfcJ27UB7rkYCgq/7258?ndn=m2";
